...
try:
    ...
    def _translate(context, text, disambig, encoding = QtCore.QCoreApplication.CodecForTr, n = None):
        if n is None:
            ...
            return QtWidgets.QApplication.translate(context, text, disambig, _encoding, n)
except AttributeError:
    def _translate(context, text, disambig, encoding = QtCore.QCoreApplication.CodecForTr, n = None):
        if n is None:
            return QtWidgets.QApplication.translate(context, text, disambig)
        else:
            return QtWidgets.QApplication.translate(context, text, disambig, QtCore.QCoreApplication.CodecForTr, n)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/can-icon-24px.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/identities.png")), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/inbox.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        item = QtGui.QTableWidgetItem()
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/addressbook.png")), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.Off)
        item.setIcon(icon3)
        ...
        self.tTLContainer.setSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        self.horizontalLayout_5.addWidget(self.pushButtonTTL, 0, QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        self.horizontalLayout_5.addWidget(self.horizontalSliderTTL, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        self.horizontalLayout_5.addWidget(self.labelHumanFriendlyTTLDescription, 1, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        self.horizontalLayout_5.addWidget(self.pushButtonSend, 0, QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/send.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/subscriptions.png")), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/subscriptions.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/can-icon-16px.png")), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/images/can-icon-16px.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
