...
]  # Mail.com support removed. They now charge for imap/smtp {'@mail':{'imap':'imap.mail.com','smtp':'smtp.mail.com','port':587,'SSL':0}}
                                        ...
                                        for line in mailbox_data:
                                            try:
                                                ...
                                                if (
                                                    ...
                                                    or "deleted" in mailbox_name.lower()
                                                    or "trash" in mailbox_name.lower()
                                                    or "drafts" in mailbox_name.lower()
                                                ):
                                                    continue
                                                if ch == "Remove Order":
