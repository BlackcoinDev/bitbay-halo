...
MODE_NUMBER: Final[int] = ...
MODE_ALPHA_NUM: Final[int] = ...
MODE_8BIT_BYTE: Final[int] = ...
MODE_KANJI: Final[int] = ...
...
def optimal_data_chunks(data: str | bytes, minimum: int = ...) -> Generator[QRData, None, None]:
    ...
...
class QRData:
    ...
    def __init__(self, data: bytes | str, mode: _SupportedMode | None = ..., check_data: Literal[True] = ...) -> None:
        ...
    @overload
