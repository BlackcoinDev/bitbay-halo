...
class BaseImage:
    ...
    def __init__(self, border: int, width: int, box_size: int, *args: Any, qrcode_modules: ModulesType | None, **kwargs: Any) -> None:
        ...
    ...
    def save(self, stream: IO[bytes], kind: str | None = ...) -> None:
        ...
    ...
    def check_kind(self, kind: str | None, transform: Callable[[str | None], str | None] | None = ...) -> str | None:
        ...
...
class BaseImageWithDrawer(BaseImage):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        module_drawer: QRModuleDrawer | str | None = ...,
        eye_drawer: QRModuleDrawer | str | None = ...,
        **kwargs: Any,
    ) -> None: ...
