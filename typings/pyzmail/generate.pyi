...
def format_addresses(addresses, header_name=..., charset=...):  # -> Header:
    """
...
def build_mail(text, html=..., attachments=..., embeddeds=...):  # -> MIMEMultipart | MIMEText | None:
    """
...
def complete_mail(
    message, sender, recipients, subject, default_charset, cc=..., bcc=..., message_id_string=..., date=..., headers=...
...
def compose_mail(
    sender, recipients, subject, default_charset, text, html=..., attachments=..., embeddeds=..., cc=..., bcc=..., message_id_string=..., date=..., headers=...
):  # -> tuple[Any, Any, list[Any], str | None]:
    """
...
def send_mail2(payload, mail_from, rcpt_to, smtp_host, smtp_port=..., smtp_mode=..., smtp_login=..., smtp_password=...):  # -> _SendErrs:
    """
...
def send_mail(payload, mail_from, rcpt_to, smtp_host, smtp_port=..., smtp_mode=..., smtp_login=..., smtp_password=...):  # -> _SendErrs | str:
    """
