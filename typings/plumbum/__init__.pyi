...
import plumbum.path
from plumbum.commands import BG, CommandNotFound, ERROUT, FG, NOHUP, ProcessExecutionError, ProcessLineTimedOut, ProcessTimedOut, RETCODE, TEE, TF
...
def __dir__():  # -> tuple[Literal['BG'], Literal['ERROUT'], Literal['FG'], Literal['NOHUP'], Literal['RETCODE'], Literal['TEE'], Literal['TF'], Literal['BaseRemoteMachine'], Literal['CommandNotFound'], Literal['LocalPath'], Literal['Path'], Literal['ProcessExecutionError'], Literal['ProcessLineTimedOut'], Literal['ProcessTimedOut'], Literal['PuttyMachine'], Literal['RemotePath'], Literal['SshMachine'], Literal['__author__'], Literal['__version__'], Literal['cmd'], Literal['local']]:
