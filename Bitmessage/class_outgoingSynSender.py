    ...
    def run(self):
        ...
        while shared.safeConfigGetBoolean("bitmessagesettings", "sendoutgoingconnections"):
            ...
            try:
                ...
                sd.setup(sock, peer.host, peer.port, self.streamNumber, someObjectsOfWhichThisRemoteNodeIsAlreadyAware)
                sd.start()
                ...
                with shared.printLock:
                    ...
                    if (
                        ...
                        and int(time.time()) - shared.knownNodes[self.streamNumber][peer] > 172800
