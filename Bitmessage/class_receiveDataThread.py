        ...
        try:
            ...
            if command == 'error':
                ...
                if command == 'addr':
                    ...
                    self.sendDataThreadQueue.put((0, 'sendaddr', shared.recentNodeList())) # This is a request to the sendDataThread to calculate the addr message and put it into its own queue.
        ...
        for i in range(numberOfRequestedInventoryItems):
            ...
            if hash in shared.inventory:
                ...
                if queryreturn != []:
                    ...
                    logger.warning('%s asked for an object with a getdata which is not in either our memory inventory or our SQL inventory. We probably cleaned it out after advertising it but before they got around to asking for it.' % str(self.peer))
